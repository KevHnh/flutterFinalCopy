  ...
  if (Firebase.apps.length == 0) {
    ...
    await Firebase.initializeApp(
      options: FirebaseOptions(
        apiKey: "AIzaSyCx7usv0cPmFYBHBMAda2RUyCfOWr98nf4",
        appId: "1:1076080372783:web:c490c0befcfd3bc5966ada",
        messagingSenderId: "1076080372783",
        projectId: "flutterfinal-2946c",
      ),
    );
  }
  setupWindow();
